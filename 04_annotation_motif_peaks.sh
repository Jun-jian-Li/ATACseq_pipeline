...
narrowPeak_dir=09_macs2_peaks_calling

mkdir 11_anno_motif/01_anno
mkdir 11_anno_motif/02_motif

anno_outdir=11_anno_motif/01_anno
motif_outdir=11_anno_motif/02_motif
